...
import {
  obtenerSolicitudAction,
  editarSolicitudAction,
...
const EditarSolicitud = () => {
  ...
  const editarSolicitud = (solicitud) =>
    dispatch(editarSolicitudAction(solicitud));
                  ...
                  <div className="col-md-6">
                    ...
                    >
                      {loading ? (
                        ...
                        <option defaultValue={solicitud.id_division}>
                          {solicitud.tc_division.descrip_division}
                        </option>
                      )}
                      {loadingDivisiones ? (
                  ...
                  <div className="col-md-6">
                    ...
                    >
                      {loading ? (
                        ...
                        <option defaultValue={solicitud.id_sucursal}>
                          {solicitud.tc_sucursal.descrip_sucursal}
                        </option>
                      )}
                  ...
                  <div className="col-md-6">
                    ...
                    >
                      {loading ? (
                        ...
                        <option defaultValue={solicitud.id_proveedor}>
                          {solicitud.tc_proveedor.descrip_proveedor}
                        </option>
                      )}
                      {loadingProveedores ? (
                  ...
                  <div className="col-md-6">
                    ...
                    >
                      {loading ? (
                        ...
                        <option defaultValue={solicitud.id_clase_pedido}>
                          {solicitud.tc_clase_pedido.descrip_clase_pedido}
                        </option>
                      )}
                      {loadingPedidos ? (
                  ...
                  <div className="col-md-6">
                    ...
                    >
                      {loading ? (
                        ...
                        <option defaultValue={solicitud.id_embarque}>
                          {solicitud.tc_embarque.descrip_embarque}
                        </option>
                      )}
                      {loadingEmbarques ? (
                  ...
                  <div className="col-md-6">
                    ...
                    >
                      {loading ? (
                        ...
                        <option defaultValue={solicitud.id_cliente}>
                          {solicitud.tc_cliente.descrip_cliente}
                        </option>
                      )}
                      {loadingClientes ? (
                  ...
                  <div className="col-md-6">
                    ...
                    >
                      {loading ? (
                        ...
                        <option defaultValue={solicitud.id_destino}>
                          {solicitud.tc_destino.descrip_destino}
                        </option>
                      )}
                      {loadingDestinos ? (
                  ...
                  <div className="col-md-6">
                    ...
                    >
                      {loading ? (
                        ...
                        <option defaultValue={solicitud.id_tipo_producto}>
                  ...
                  <div className="col-md-6">
                    ...
                    >
                      {loading ? (
                        ...
                        <option defaultValue={solicitud.id_moneda}>
